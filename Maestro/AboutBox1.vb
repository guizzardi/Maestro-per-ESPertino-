Public NotInheritable Class AboutBox1
    ...
    Private Sub AboutBox1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.LabelVersion.Text = String.Format("Versione {0}", My.Application.Info.Version.ToString) & " (BETA)"
        Me.LabelCopyright.Text = My.Application.Info.Copyright
        Me.LabelCompanyName.Text = My.Application.Info.CompanyName
        Me.TextBoxDescription.Text = My.Application.Info.Description & vbNewLine &
            "Questo programma è di proprità della Brain & Bytes. " & vbNewLine & vbNewLine &
            "ESPertino è di proprietà di Elettronica Open Source"
